...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT(
        ...
        KC_LALT, KC_Z, KC_X, KC_C,    KC_D,    KC_V,    UKC_SNAKE,  UKC_CONST, KC_K,     KC_H,     KC_COMM, KC_DOT, KC_SLSH, KC_TAB,
                             KC_LCTL, TL_LOWR, KC_LSFT, KC_SPC,     KC_BSPC,   KC_ENT,   TL_UPPR,  KC_RSFT
    ),
    ...
    [_NAV] = LAYOUT(
        ...
        _______, S(KC_F7), KC_F7,    UKC_PFIND, UKC_NFIND, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, _______,
                                     _______,   _______,   _______, _______, _______, _______, _______, _______
    ),
